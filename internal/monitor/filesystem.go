...
type FileWatcher struct {
	...
	maxOps     int
	stopCh     chan struct{}
	snapshots  map[string]map[string]time.Time // dir -> file -> modtime
}
...
// takeSnapshots captures the current state of watched directories
...
// detectChanges compares current state against snapshots
...
// addOp adds a file operation (must be called with lock held)
