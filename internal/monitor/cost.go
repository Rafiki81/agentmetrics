...
// modelPrices maps model name patterns to pricing (USD per 1M tokens, Feb 2026)
...
func findPricing(model string) ModelPricing {
	...
	// Try prefix/substring matching (model names often have version suffixes)
	// Sort by longest key first for best match
	bestMatch := ""
	...
	// Heuristic: if model name contains known prefixes, use base pricing
